    		...
    		if (layerName) {
    			...
    			if (n != -1 || o != -1){
    				...
    				switch(layerName){
    					...
    					case "1998 Orthophoto" : allOrthos.setVisibleLayers([33]); break;
    					case "2001 Orthophoto" : allOrthos.setVisibleLayers([32]); break;
    					case "2003 Satellite" : allOrthos.setVisibleLayers([31]); break;
    					case "2004 Orthophoto" : allOrthos.setVisibleLayers([26]); break;
    					case "2005 Orthophoto" : allOrthos.setVisibleLayers([21]); break;
    					case "2006 Orthophoto" : allOrthos.setVisibleLayers([16]); break;
    					case "2007 Orthophoto" : allOrthos.setVisibleLayers([11]); break;
    					case "2008 Orthophoto" : allOrthos.setVisibleLayers([10]); break;
    					case "2009 Orthophoto" : allOrthos.setVisibleLayers([9]); break;							
    					case "2010 Orthophoto" : allOrthos.setVisibleLayers([8]); break;
    					case "2011 Orthophoto" : allOrthos.setVisibleLayers([7]); break;
    					case "2012 Orthophoto" : allOrthos.setVisibleLayers([6]); break;					
    					case "2013 Orthophoto" : allOrthos.setVisibleLayers([5]); break;
    					case "2014 Orthophoto" : allOrthos.setVisibleLayers([2]); break;
    					case "2015 Orthophoto" : allOrthos.setVisibleLayers([1]); break;
						case "2016 Orthophoto" : allOrthos.setVisibleLayers([0]); break;
